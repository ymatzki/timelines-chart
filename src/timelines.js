...
export default Kapsule({
  ...
  update(state) {
    ...
    function setupDimensions() {
      ...
      // ]);
      state.graphH = window.innerHeight;

      state.height = state.graphH + state.topMargin + state.bottomMargin;
      console.log("state.graphH", state.graphH, "state.height", state.height);
    ...
    function renderTimelines(maxElems) {
      ...
      // Line height
      console.log("state.graphH", state.graphH, "state.nLines", state.nLines);
      // state.lineHeight = (state.graphH / state.nLines) * 0.8;
      state.lineHeight = 14;
      console.log("state.lineHeight", state.lineHeight);
      ...
      newSegments
        ...
        .on("click", function (ev, s) {
          console.log("click", state.onSegmentClick);
